...
public class GatheringController {
	...
	public Result findAll(){
		return new Result(true,1000,"查询成功",gatheringService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(true,1000,"查询成功",gatheringService.findById(id));
	}
	...
	public Result findPage(@PathVariable int page,@PathVariable int size){
		...
		return new Result(true,1000,"查询成功",new PageResult<Gathering>(pageList.getTotalElements(), pageList.getContent() ) );
	}
